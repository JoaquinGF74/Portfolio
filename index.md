...
✉️ [joacogf2002@gmail.com](mailto:joacogf2002@gmail.com) | [LinkedIn - Joaquin Gonzalez Fontan](www.linkedin.com/in/joaquin-gonzalez-fontan)
...
## 📚 Relevant Coursework
- **Data Structures & Algorithms**: Worked with Algorithms and Data Structures considering O(n) notation.
- **Databases with SQL**: Database System programming in SQL
...
- **Vizualizations**: Tableau, Canva 
- **Programming**: C++, Python, RStudio, SQL     
...
- Designed and implemented machine learning algorithms to track player performance
- Developed backend-to-frontend communication systems for efficient data sharing
- Created pattern recognition algorithms to analyze player statistics and development

### **HG Desarrollos Inmobiliarios | Buenos Aires, Argentina**
*Field Construction Assistant (Dec 2016 - Feb 2018)*
- Assisted in constructing water and electric systems for buildings by transporting materials and
supporting the chief plumbern and chief electrician
...
**Student Athlete – Division 1 Rugby (Aug 2021 – May 2025)**  
- **15+ hrs/week** of training as part of the Men’s Rugby Team.
- **Ranked** between 2nd and 4th place in the USA Rugby ranking.
- **Captained** multiple games
